      ...
      <div className="px-56 py-28 max-lg:px-16 max-sm:px-6">
        <div className="mt-12 flex items-center justify-center gap-32 max-sm:flex-col">
          ...
          <div className="flex w-1/2 flex-col gap-4 text-justify leading-7 max-sm:-mt-10 max-sm:w-full">
            <p className="text-wrap">
              Olá, eu sou{' '}
              <span className="font-bold text-primary">Felippe Donatto</span>,
              sou desenvolvedor front-end com{' '}
              <span className="font-bold">10 anos</span> de experiência.
              Apaixonado pela programação,{' '}
              <span className="font-bold text-primary">ouso</span> a criar
              minhas próprias <span className="font-bold">APIs</span>,
              explorando gradualmente o mundo do{' '}
              <span className="font-bold">backend</span>. Como entusiasta da
              arte, também me aventuro no
              <span className="font-bold">design UI/UX</span>, embora não seja
              um profissional de design, tenho conhecimentos em{' '}
            ...
            <p>
              ...
              ideias em{' '}
              <span className="font-bold text-primary">realidade</span> digital!
            </p>
          </div>
        </div>
        ...
        <div className="my-8">
          <div className="flex flex-col gap-6">
            ...
            <div
              className="border-l-4 p-4  leading-6 text-zinc-400"
              id="bioText"
            >
              <p className="text-wrap">
