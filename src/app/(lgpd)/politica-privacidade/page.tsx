  ...
  return (
    <section className="gap-8 bg-white px-56 py-16 text-zinc-900 max-xl:px-16 max-sm:px-6">
      ...
      <p className="py-3 text-justify">
        A sua privacidade é importante para nós. É política do site Donatto Dev
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site{' '}
        <a href="http://donattodev.com.br/" target="_blank" rel="noopener">
          Donatto Dev
        </a>
      ...
      <p className="py-3 text-justify">
        ...
        <a href="http://donattodev.com.br/atendimento" target="_blank">
          do nosso formulário
        </a>
        .
      </p>
      ...
      <p className="py-3 text-justify">
        ...
        de Privacidade pode ser alterado a critério do site Donatto Dev,
      ...
      <p className="py-3 text-justify">
        O site Donatto Dev não se responsabiliza caso você venha utilizar seus
        dados de forma incorreta ou inverídica, ficando excluído de qualquer
        responsabilidade neste sentido.
      </p>

      <h2 className="py-3 text-xl font-bold">Política de Cookies</h2>

      <h3 className="py-3 text-lg font-bold">O que são cookies?</h3>
      ...
      <h3 className="py-3 text-lg font-bold">Como usamos os cookies?</h3>
      ...
      <h3 className="py-3 text-lg font-bold">Desativar cookies</h3>
      ...
      <h3 className="py-3 text-lg font-bold">Cookies que definimos</h3>
      ...
      <ul className="flex flex-col gap-3">
        <li className="text-justify">
          ...
          cookies podem ser usados para lembrar se você já está registrado e se
          deve mostrar determinadas notificações válidas apenas para usuários
        ...
        <li className="text-justify">
          <strong>Cookies de preferências do site</strong>Para proporcionar uma
          ótima experiência neste site, fornecemos a funcionalidade para definir
          ...
          uma página que for afetada por suas preferências.
        </li>
      </ul>

      <h3 className="py-3 text-lg font-bold">Cookies de Terceiros</h3>
      ...
      <h3 className="py-3 text-lg font-bold">Compromisso do Usuário</h3>

      <p className="py-3 text-justify">
        O usuário se compromete a fazer uso adequado dos conteúdos e da
        informação que o site Donatto Dev oferece e com caráter enunciativo, mas
        não limitativo:
      </p>
      ...
      <ul className="flex flex-col gap-3">
        ...
        <li className="text-justify">
          ...
          (softwares) do site Donatto Dev, de seus fornecedores ou terceiros,
      ...
      <h2 className="py-3 text-xl font-bold">Direitos do titular de dados</h2>

      <p className="py-3 text-justify">
        O titular de dados pessoais possui o direito de solicitar do site
        Donatto Dev, através do canal específico de tratamento, a qualquer
      ...
      <ul className="flex flex-col gap-3">
        ...
        <li className="text-justify">Acesso aos seus dados pessoais;</li>
        ...
        <li className="text-justify">Revogação do consentimento.</li>
      </ul>
      ...
      <ul>
        ...
        <li className="text-justify">
          ...
          dados pessoais, entre em contato conosco através{' '}
          <a href="http://donattodev.com.br/atendimento" target="_blank">
            do nosso formulário
          </a>
          ;
      ...
      <h2 className="py-3 text-xl font-bold">Mais informações</h2>
      ...
      <p className="py-3 text-justify">
        O site Donatto Dev empregará esforços para resguardar as informações e
        ...
        seguro, o site Donatto Dev não pode assegurar que terceiros não
